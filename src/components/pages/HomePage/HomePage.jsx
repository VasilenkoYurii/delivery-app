...
export const HomePage = () => {
  return (
    <>
      <div>
        <img
          src="https://www.mcdonalds.com/content/dam/sites/ua/nfl/app-promo/475x360!.jpg"
          alt="mc-donalds"
        />
        <p>Get discounts and special offers after your first order</p>
      </div>

      <div>
        <NavLink to="shop/mcDonalds">
          <img
